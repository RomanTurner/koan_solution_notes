...
=begin
    # THINK ABOUT IT:
    #!URL https://stackoverflow.com/questions/14595169/benefits-of-using-hashfetch-over-hash
...
=begin
    ...
    so it should be "broken out into a variable"
    but you can always use assert_equal({ :one => "eins", :two => "dos" }, hash)
    #!URL https://stackoverflow.com/questions/7533711/what-is-the-answer-to-the-bonus-question-in-test-changing-hashes-of-ruby-koans
=end
  end
