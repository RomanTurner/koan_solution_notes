...
class AboutStrings < Neo::Koan
  ...
  #Flexible quotation is to avoid the leaning toothpick syndrome
...
It was the worst of times.
  ...
  #It is convention to use EOS, not a hard rule
...
=begin
    # THINK ABOUT IT:
    #! URL https://stackoverflow.com/questions/4684446/why-is-the-shovel-operator-preferred-over-plus-equals-when-building-a
